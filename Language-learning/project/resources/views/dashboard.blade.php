                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        @foreach(Auth::user()->result as $result)
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    @switch(ucfirst($result->quiz->language->language))
                                                        @case('German')
                                                        <img class="h-10 w-10 rounded-full"
                                                             src="https://upload.wikimedia.org/wikipedia/en/thumb/b/ba/Flag_of_Germany.svg/1200px-Flag_of_Germany.svg.png"
                                                             alt="">
                                                ...
                                                <div class="text-sm text-gray-500">{{ucfirst($result->quiz->language->language)}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <form method="get" action="{{ route('quizzes.solutions.index',['quiz'=>$result->quiz]) }}">
                                                    <x-button class="ml-4" id="discusion.{{$result->quiz->id}}">
                                                        {{ __('My answers') }}
                                                    </x-button>
                                                </form>
                                            </td>
